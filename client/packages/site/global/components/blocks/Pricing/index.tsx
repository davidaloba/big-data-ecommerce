        ...
        {pricingCards &&
          pricingCards.map((card, index) => (
            <div
              ...
              <p className="text-gray-900 dark:text-gray-50 text-3xl font-bold">
                ${card.price}
              ...
              <button
                type="button"
                className="py-2 px-4 bg-secondary hover:bg-secondary-darker text-gray-50 w-full transition ease-in duration-200 text-center text-base font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2  rounded-lg ">
                Choose plan
              </button>
            </div>
          ))}

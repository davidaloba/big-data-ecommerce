...
import { toggleEdit, logoutHandler } from '../../../store/action'

//img

import  user1  from  '../../assets/images/user/avatar.png'
// import  user01  from  '/src/assets/images/user/01.jpg'
// import  user02  from  '/src/assets/images/user/02.jpg'
// import  user03  from  '/src/assets/images/user/03.jpg'
// import  user04  from  '/src/assets/images/user/04.jpg'
// import  user05  from  '/src/assets/images/user/05.jpg'
                                ...
                                <Card className="shadow-none m-0">
                                    <Card.Header className="d-flex justify-content-start bg-primary p-0">
                                        <div className="bg-primary p-3">
                                            <h5 className="mb-0 text-white line-height">{`Hello ${userInfo.name}`}</h5>
                                    ...
                                    <Card.Body className="p-0 ">
                                        ...
                                        <div className="d-inline-block w-100 text-center p-3">
                                                    <button className="bg-primary iq-sign-btn" onClick={logoutHandler} >Sign out<i className="ri-login-box-line ml-2"></i></button>
                                        </div>
                                    </Card.Body>
                                </Card>    
                            </Dropdown.Menu>

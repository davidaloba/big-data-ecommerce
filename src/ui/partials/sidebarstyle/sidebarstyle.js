...
// import {getDarkMode} from '/src/store/mode'
                ...
                <div className="iq-sidebar-logo d-flex justify-content-between">
                    <Link to="/" className="header-logo">
                        ...
                        <div className="logo-title">
                            <span className="text-primary">Omega Gospel TV</span>
                        </div>
                    </Link>
                    ...
                    <nav className="iq-sidebar-menu">
                        <Accordion as="ul" id="iq-sidebar-toggle" className="iq-menu" onSelect={(e) => setActiveMenu(e)}>
                            ...
                            <li className={activeMenu === '1' ? 'active' : ''}>
                                <Accordion.Toggle as={Button} href="#" eventKey="1" variant=" collapsed" data-toggle="collapse" aria-expanded="false"><i className="las la-film"></i><span>Messages</span><i className="ri-arrow-right-s-line iq-arrow-right"></i></Accordion.Toggle>
                                <Accordion.Collapse className="submenu" eventKey="1">
                                    <ul id="movie" className="iq-submenu" data-parent="#iq-sidebar-toggle">
                                        <li className={`${location.pathname === '/add-message' ? 'active' : ''} `}><Link to="/add-message"><i className="las la-user-plus"></i>Add Movie</Link></li>
                                        <li className={`${location.pathname === '/message-list' ? 'active' : ''} `}><Link to="/message-list"><i className="las la-eye"></i>Movie List</Link></li>
                                    </ul>
                                </Accordion.Collapse>
                            </li>
                            ...
                            {userInfo.isSuperAdmin && <li className={activeMenu === '3' ? 'active' : ''}>
                                <Accordion.Toggle as={Button} href="#" eventKey="3" variant=" collapsed" data-toggle="collapse" aria-expanded="false"><i
                                    className="las la-user-friends"></i><span>Admins</span><i
                                        className="ri-arrow-right-s-line iq-arrow-right"></i>
                                </Accordion.Toggle>
                                <Accordion.Collapse className="submenu" eventKey="3">
                                    <ul id="show" className="iq-submenu" data-parent="#iq-sidebar-toggle">
                                        <li className={`${location.pathname === '/add-admin' ? 'active' : ''} `}><Link to="/add-admin"><i className="las la-user-plus"></i>Add Admin</Link></li>
                                        <li className={`${location.pathname === '/admin-list' ? 'active' : ''} `}><Link to="/admin-list"><i className="las la-eye"></i>Show Admins</Link></li>
                                    </ul>
                                </Accordion.Collapse>
                            </li>}
                            {/* <li className={`${location.pathname === '/userlist' ? 'active' : ''} `}>
                            <Link to="/userlist" className="iq-waves-effect">

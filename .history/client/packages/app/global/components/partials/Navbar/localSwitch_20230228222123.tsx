...
const localeSwitch = ({ pageData, type, locale: language }) => {
  ...
  return (
    <div
      ...
      <div>
        <button
          className=" md:pr-2 hover:bg-primary-50 hover:text-primary-600 focus:bg-primary-50 focus:text-primary-600 focus:outline-none flex items-center justify-between cursor-pointer rounded-md"

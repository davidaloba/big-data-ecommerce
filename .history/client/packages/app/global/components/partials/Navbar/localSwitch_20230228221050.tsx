...
const localeSwitch = ({ pageData, type, locale: language }) => {
  ...
  return (
    <div
      // className="inline-block max-w-min text-left"
      ref={select}>
        <button
          className=" hover:bg-primary-50 hover:text-primary-600 focus:bg-primary-50 focus:text-primary-600 focus:outline-none flex items-center justify-between md:pl-8 cursor-pointer rounded-md"
